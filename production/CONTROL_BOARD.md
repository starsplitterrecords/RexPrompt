...
| **Vikings 2026** | Issue 1 released: 26 reader pages + collected PDF. Visions also contains an Issue 2 release record dated 2026-08-22, but there is no Issue 2 cover/link, no Issue 2 page directory, and no Issue 2 PDF directory. | Issues 2–6 are production-ready 24-page packages. Issue 7 and Issue 8 have full 24-page development scripts but are not yet compiled. Issue 9 remains optional/unresolved. | None. | Correct or intentionally complete the stray Visions Issue 2 release record. Then production-edit and compile Issues 7–8. Open decisions remain on the two male Kin names, exact Issue 8 legal ruling/terminology, and whether Issue 9 is needed. |
...
5. **Vikings has the clearest Visions metadata defect.** Issue 2 is catalogued as released but has no release assets.
6. **Division Threshold has a source-mapping inconsistency.** RexPrompt expects a Visions slug that does not currently exist.
7. **Backyard Rockets needs a count verification, not an automatic fix.** The 47 reader assets may be correct if the advertised 48-page edition includes a cover/editorial page outside the reader.

## Immediate non-image work queue

1. **Low Tide Signal — finish recovery-state cleanup and sanitize the active reference tree.**
2. **Vikings 2026 — resolve the false/incomplete Issue 2 release record; production-edit and compile Issues 7–8.**
