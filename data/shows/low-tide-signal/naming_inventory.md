...
| C04 | LTS_C04_P05 | summary | 4-panel page. Opening image: Editing timeline: Tide Town footage beside client work. Final image: Client message arrives; smile dies a little. |
| C04 | LTS_C04_P05 | panelPlan[0] | Editing timeline: Tide Town footage beside client work. |
| C04 | LTS_C04_P05 | dialogueInline[1].text | this the Low Tide District? |
| C04 | LTS_C04_P23 | summary | 4-panel page. Opening image: On the district route, Ryan holds Matt’s phone between them with MATT’S CUT tagged in a runner post. Final image: Chris stops at a wet concrete wall where one of his phrases has been painted large and stops smiling. |
| C04 | LTS_C04_P23 | panelPlan[0] | On the district route, Ryan holds Matt’s phone between them with a runner post tagging MATT’S CUT. |
...
| C05 | LTS_C05_P03 | dialogueInline[0].text | I preferred Tide Town when we were obscure. |
| C06 | LTS_C06_P11 | dialogueInline[0].text | LOW TIDE DISTRICT / RETURN TIDE — what really happened |
| C06 | LTS_C06_P11 | dialogueInline[1].text | MATT'S CUT / SOUTH TEETH / DEEP SECTOR |
| C06 | LTS_C06_P24 | dialogueInline[0].text | Last big one into the District before winter. Daylight. Five max. In and out. |
| C07 | LTS_C07_P07 | panelPlan[2] | All five keep their hands on straps, rails or pockets while the district fills the background. |

Visible Reach occurrences: **0**
Tracked naming occurrences: **33**
