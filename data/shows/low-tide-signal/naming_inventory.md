...
| C01-C03 | LTS_C03_P20 | `panelPlan[0]` | A story runner holds both arms wide while describing an impossible municipal sign from an outer sector. |
| C04 | LTS_C04_P01 | `panelPlan[1]` | Matt sits up; packed Reach bag in foreground, work clothes prepared beyond it. |
| C04 | LTS_C04_P05 | `summary` | 4-panel page. Opening image: Editing timeline: Reach footage beside client work. Final image: Client message arrives; smile dies a little. |
| C04 | LTS_C04_P05 | `panelPlan[0]` | Editing timeline: Reach footage beside client work. |
| C04 | LTS_C04_P23 | `summary` | 4-panel page. Opening image: On the Reach route, Ryan holds Matt’s phone between them with MATT’S CUT tagged in a runner post. Final image: Chris stops at a wet concrete wall where one of his phrases has been painted large and stops smiling. |
| C04 | LTS_C04_P23 | `panelPlan[0]` | On the Reach route, Ryan holds Matt’s phone between them with a runner post tagging MATT’S CUT. |
...
| C05 | LTS_C05_P01 | `dialogueInline[1].text` | deep sector maybe walkable |
| C05 | LTS_C05_P06 | `panelPlan[2]` | Distant Reach looks deceptively close. |
| C06 | LTS_C06_P11 | `dialogueInline[1].text` | MATT'S CUT / SOUTH TEETH / DEEP SECTOR |
| C07 | LTS_C07_P07 | `panelPlan[2]` | All five keep their hands on straps, rails or pockets while the Reach fills the background. |
| C07 | LTS_C07_P11 | `summary` | 4-panel page. Opening image: Glass Rail extends into less-explored district. Final image: Group keeps measured pace. |
| C07 | LTS_C07_P11 | `panelPlan[0]` | Glass Rail extends into less-explored district. |
| C07 | LTS_C07_P13 | `summary` | 4-panel page. Opening image: Close view of a blank public schedule sheet trapped behind cloudy cracked plastic on a deep-Reach civic wall; faded mounting holes and water marks surround the empty grid. Final image: Chris looks from the schedule to Nicole and Kevin, says “That’s enough,” then turns away with them; the final panel leaves the blank schedule behind as all three rejoin the route. |
| C07 | LTS_C07_P13 | `panelPlan[0]` | Close view of a blank public schedule sheet trapped behind cloudy cracked plastic on a deep-Reach civic wall; faded mounting holes and water marks surround the empty grid. |
| C07 | LTS_C07_P20 | `panelPlan[2]` | Nicole slows and looks back over one shoulder toward the fog-covered Reach while the others continue two steps ahead. |
