...
|---|---|---|---|
| C01-C03 | LTS_C01_P01 | summary | Full-page composition: Full-page wide city view in gray-blue rain: raised transit crosses above flood-control gates; occupied apartment windows, food stalls, umbrellas, automated freight and wet sidewalks fill Harbor Phase. |
| C01-C03 | LTS_C01_P01 | panelPlan[0] | Full-page wide city view in gray-blue rain: raised transit crosses above flood-control gates; occupied apartment windows, food stalls, umbrellas, automated freight and wet sidewalks fill Harbor Phase. |
| C01-C03 | LTS_C01_P02 | summary | 3-panel page. Opening image: Wide interior of raised transit with Matt seated by a rain-streaked window; commuters read, talk and hold bags around him. Final image: Close on the calm route display beside Matt as the four-minute adjustment appears; nobody nearby looks up. |
| C01-C03 | LTS_C01_P02 | panelPlan[0] | Wide interior of raised transit with Matt seated by a rain-streaked window; commuters read, talk and hold bags around him. |
| C01-C03 | LTS_C01_P02 | panelPlan[1] | Through the window, water covers a lower downtown street while barriers and drainage lanes redirect it below the train. |
