...
## Story lock
This issue is not a civic-system lesson. It shows that the Vikings have begun to live in New York when nobody is formally teaching them how.

The neighborhood remembers them through repetition: the same bodega, coffee cart, hallway, park, library, merchants, and ordinary routes. The Kin remain mostly background figures, quietly doing more independent living than Carrie notices. Gunnar must broaden beyond navigation/logistics. The library is one ordinary destination within a lived day, not the issue premise.
...
1. Wide apartment. The room is still recognizably the Safe Cave, but now layered with ordinary city life: grocery bags, MetroCards, library flyer, laundry bag, toaster, coffee cups, brass key. One Kin member is tying a shopping bag shut. Another is halfway out the door with laundry. A third eats something packaged while looking at a neighborhood flyer.
2. Carrie enters with a folder, already talking.
   **CARRIE:** Okay. Today we need to—
3. She stops. The room is in motion without her.
4. Bjorn drinks coffee from a paper cup like this has become routine.
   **BJORN:** We have begun.
5. Carrie looks at the folder in her hand.
   **CARRIE:** Apparently.

## Page 2 — DOWNSTAIRS
**4 panels. Apartment hallway / stoop.**

1. The group descends, but not as a military column. They separate naturally at the building entrance.
2. One Kin member heads toward the laundromat with a bag. Another crosses toward a neighbor carrying snacks. No dialogue explaining this.
3. Carrie notices them splitting up.
   **CARRIE:** Where are they going?
4. Gunnar, already walking another direction with Bjorn:
   **GUNNAR:** Out.

## Page 3 — THE BODEGA KNOWS THEM
**5 panels. Recurring neighborhood bodega.**

1. Bjorn enters. The Bodega Owner does not look surprised.
...
1. Gunnar and Bjorn approach the cart. The vendor sees Bjorn and starts preparing coffee before they arrive.
...
1. They approach a neighborhood library. No awe splash. People enter and leave normally.
2. Gunnar holds the door for an elderly patron. She nods thanks. He nods back.
3. Inside, Bjorn lowers his voice because everyone else has.
4. Carrie notices this tiny adaptation and says nothing.

## Page 9 — WHY THEY CAME
...
1. Gunnar browses slowly. No tactical overlay, no route logic.
2. His hand stops on poetry / sagas / translated literature. Avoid locking a specific real title unless visible only as generic category dressing.
3. He opens a book and reads a few lines silently.
4. His expression changes—not comic confusion; recognition and interest.
5. He sits down.

## Page 11 — BJORN FINDS HIMSELF BADLY DRAWN
**5 panels. History section.**

1. Bjorn pulls a general illustrated book about Vikings/Norse history.
2. Illustration shows a familiar pop-history cliché.
3. Bjorn studies it.
   **BJORN:** No.
...
**5 panels. Library copier/computer area.**

1. Carrie is at a terminal/copier working through city records. This is background competence, not a lesson sequence.
2. She looks over and sees Gunnar reading, Bjorn with a stack of books, both independently occupied.
3. Her phone buzzes with a DTI notification.
4. She silences it.
5. For once she lets them remain where they are rather than summoning them.
...
## Page 15 — BORROWING
**5 panels. Library checkout.**

1. Gunnar arrives with a small stack of books.
2. Carrie:
...
## Page 17 — THE CITY GIVES THINGS BACK
**5 panels. Library exit / sidewalk.**
...
## Page 19 — HOTDOG VENDOR / PARK BENCH
**5 panels.**

1. Familiar hotdog vendor recognizes them.
2. Transaction is nearly wordless; the vendor already knows quantities/condiments well enough to start.
3. They sit on a familiar park bench. Silas remains nearby but not performing.
4. Gunnar reads while eating. Bjorn people-watches.
5. A local passerby gives Bjorn a small nod. Bjorn returns it.

## Page 20 — BJORN'S KIND OF MAP
**4 panels.**
...
1. Everyone arrives with things from different parts of the neighborhood: books, groceries, laundry, snacks, small cultural flyers, coffee cups.
2. The apartment absorbs them into existing Viking domestic organization.
3. Gunnar puts his borrowed books somewhere protected, not near his maps.
4. Bjorn sets his inaccurate Viking history book near the brass key.
5. Carrie notices the visual juxtaposition: home granted by the city; history borrowed from the city.

## Page 23 — CARRIE'S FOLDER
**4 panels.**
...
1. Bodega Owner wipes counter; one of the Vikings' familiar items sits behind him.
2. Coffee vendor serves another customer; Bjorn's regular cup order notation / remembered routine is implicit in the setup, not labeled for exposition.
3. Library return slot / desk, establishing this is a place they will come back to.
4. Laundromat television glows over folding tables; a Kin member's familiar presence is now part of the room.
5. Apartment window at dusk. The Safe Cave glows among hundreds of ordinary city windows.
6. Inside, Gunnar reads. Bjorn argues silently with the illustration in his history book. The Kin continue their own activities in the background. Carrie sits for once without managing anyone.

**END ISSUE 5**

## Continuity / future payoff notes
- Preserve recurring Bodega Owner, street vendor/coffee guidance, hotdog vendor, library, laundromat, hallway neighbor and park as neighborhood-memory assets.
- Do not explain the Kin's competence yet. These visual seeds should later support the reveal that they have been integrating independently all season.
- Gunnar's books establish interests beyond navigation; future writing should not default him back into map/system exposition whenever he appears.
- Bjorn's adaptation remains social/ritual: recognition, repeated exchange, obligations, returned greetings, known merchants.
- Carrie's emotional progression is subtle: integration is beginning to mean that the Vikings sometimes function without her mediation.
- Silas is present but reduced in narrative dominance; helping carry the document bag is a small annoying-to-endearing step.
- The library remains a reusable recurring place, not a one-off lesson environment.
- Hearing setup is implicit only: these repeated civilian relationships may later become memory/evidence of belonging.
